...
# Version: 6.21 (English localization, NVIDIA pkg lock feature for legacy GPUs)
# ==============================================================================
...
# NVIDIA Sub-menu (Hardcoded known branches to avoid dependency breakages)
NVIDIA_BRANCH=""
if [ "$GPU_CHOICE" -eq 1 ]; then
    bsddialog --title "NVIDIA Driver Version" \
              --menu "Select the NVIDIA driver branch for your GPU:" 15 75 6 \
...
case "$GPU_CHOICE" in
    1)
        ...
        bsddialog --title "NVIDIA Package Lock" \
                  --yesno "Do you want to lock the NVIDIA driver packages?\n\nThis prevents 'pkg upgrade' from automatically updating them and potentially dropping support for your GPU (e.g., Quadro P2000)." 12 70
        if [ $? -eq 0 ]; then
...
# ==============================================================================
# 11. METAPACKAGES (Internet, Media, Vbox, etc.)
# ==============================================================================
